...
class IndexPage extends RaxanWebPage {
    ...
    protected function _init() {
        ...
        try {
           ...
           // $this->db = $this->Raxan->connect('raxandb'); // connect to db
            // $this->
            // var_dump($this);
            //$this->redirectToView('directory'); // redirects to the "thank-you" view

            // $view = $this->getView('index.php');
            // $this->content($view);  // set the content of the page
    ...
    protected function saveForm($e) {
        // do something here
        //$this->redirectToView('addForm'); // redirects to the "thank-you" view
    }
